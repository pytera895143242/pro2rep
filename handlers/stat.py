...
async def statistika(message: types.Message):
    ...
    if chat_id in time_sleep:
        await message.answer(text = "Статистику можно выгружать не чаще чем 1 раз в 8 часов")
    else:
        ...
        if chat_id in time_sleep:
            ...
            time_sleep.append(chat_id)

        await asyncio.sleep(28800)
        
        try:
            time_sleep.remove(chat_id)
        except:pass
